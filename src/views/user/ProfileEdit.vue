...
watch(
  ...
  (newAge, oldAge) => {
    eligibilityStatus.value =
      newAge >= 18 ? "Eligible for voting" : "Not eligible for voting";
  },
  { immediate: true }
);
...
<template>
  ...
  >
    ...
    <button
      ...
      class="block w-full text-center text-white bg-green-600 text-sm font-semibold rounded-lg hover:bg-green-500 focus:outline-none focus:shadow-outline focus:bg-green-500 hover:shadow-xs p-3 my-4"
    >
      Update Profile
    </button>
  </div>
